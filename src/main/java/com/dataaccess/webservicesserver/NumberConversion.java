 ...
 * 2022-08-03T12:59:24.053+05:30
 * Generated source version: 3.5.3
 *
 */
@WebServiceClient(name = "NumberConversion",
                  wsdlLocation = "file:/C:/stsworkspace/SoapNumber-2/src/main/resources/wsdl/dataaccess-numberconversion.wsdl",
...
public class NumberConversion extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/stsworkspace/SoapNumber-2/src/main/resources/wsdl/dataaccess-numberconversion.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(NumberConversion.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/stsworkspace/SoapNumber-2/src/main/resources/wsdl/dataaccess-numberconversion.wsdl");
        }
        WSDL_LOCATION = url;
    }
